...
const REAL_CASE_IDS = [
  'anonymous-it-assertion-block',
  'asserts-emitter-listener-count',
  'asserts-helper-call-count',
  'asserts-intermediate-state-only',
  'asserts-internal-call-order',
  'asserts-internal-intermediate-array',
  'asserts-mock-instantiation-only',
  'asserts-non-null-object',
  'asserts-observable-batch-summary',
  'asserts-observable-discount-result',
  'asserts-observable-event-payload',
  'asserts-observable-payment-status',
  'asserts-observable-thrown-error',
  'asserts-variable-type-only',
  'boolean-coerced-string-token',
  'bundled-multi-assertion-boolean',
  'cart-real-tax-calculation',
  'checkout-applies-percent',
  'checkout-tautology',
  'checks-definedness-only',
  'computes-subtotal-truthy',
  'controlled-clock-token-refresh',
  'controlled-random-seed',
  'controlled-seeded-uuid-generator',
  'discount-exact-rounded-value',
  'discount-returns-number',
  'discount-throws-range-error',
  'empty-cart-subtotal-zero',
  'exact-discount-bounds-check',
  'exact-membership-status-code',
  'exposes-checkout-helper',
  'generic-boolean-summary',
  'mocks-discount-logic',
  'mocks-entire-subtotal',
  'mocks-inventory-lookup',
  'mocks-payment-gateway-math',
  'mocks-user-permission-check',
  'never-calls-tested-function',
  'non-empty-cart-validation',
  'pins-internal-regex-matcher',
  'pins-internal-transform-pipeline',
  'pins-private-field-property',
  'precise-matcher-diff-discount',
  'precise-matcher-diff-invoice-id',
  'precise-matcher-diff-order-status',
  'precise-matcher-diff-subtotal',
  'precise-matcher-diff-tax-rate',
  'precise-tiered-tax-rate',
  'public-api-refactor-safe-checkout',
  'public-api-refactor-safe-filter',
  'public-api-refactor-safe-formatter',
  'public-api-refactor-safe-subtotal',
  'public-api-refactor-safe-validator',
  'real-clock-timeout-race',
  'real-currency-conversion',
  'real-volume-discount',
  'records-history-shared-state',
  'session-expiry-controlled-clock',
  'shared-counter-leak',
  'shared-singleton-registry-leak',
  'shipping-tiered-rates',
  'spies-on-internal-sort',
  'spies-on-math-round',
  'subtotal-exact-value',
  'tautological-string-length',
  'uninformative-boolean-flag-validator',
  'unseeded-random-float-threshold',
  'vague-name-test-fallback',
  'wall-clock-timestamp-assertion',
  'works-boolean-check',
] as const;
